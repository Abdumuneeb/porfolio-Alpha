      ...
      <section className="bg-navbar-bg">
        <div className="container">
          ...
          >
            ...
            <div
              className={`${styles.contentWrapper} flex flex-col lg:ml-28 lg:mt-0 lg:mb-0 sm:mt-44 md:mt-48 md:mb-5 lg:justify-start lg:items-start sm:mx-auto sm:justify-center sm:items-center`}
            >
            ...
            <div
              className={`${styles.imgWrapper} lg:absolute lg:right-12 lg:left-auto lg:-top-30  sm:-top-80 sm:mx-auto sm:left-16`}
            >
              <Image
                src="/profile.png"
                width="438"
